...
## [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **adaptive_algorithm_1** [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/d3/ia)

```yaml

Name of QuantLet : adaptive_algorithm_1

Published in : 'Unpublished - Theoretical description of how to forecast the disaster of stock
market'

Description : 'Applies the adaptive algorithm on the model proposed by Barrow (2006) to capture the
disaster of stock market and forecast stock price.'

Keywords : regression, classification, stock-price, simulation, forecast

Author : Luhui Lin

Example : prediction, Coefficient varying
